...
public:
    ...
    Eigen::Vector2d world2camera (const Eigen::Vector3d& point3D_w) const;

    Eigen::Vector2d camera2world (const Eigen::Vector3d& point3D_c) const;

    Eigen::Vector2d camera2image (const Eigen::Vector3d& point3D_c) const;

    Eigen::Vector2d image2world (const Eigen::Vector2d& point2D, const double depth) const;

    Eigen::Vector2d image2camera (const Eigen::Vector2d& point2D, const double depth) const;
