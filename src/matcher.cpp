...
//   std::shared_ptr<Frame>& refFrame, std::shared_ptr<Frame>& curFrame, Feature& ft, const double minDepth, const double maxDepth, double& estimatedDepth
//   )
// {
//     return false;
// }

void Matcher::templateMatching( const std::shared_ptr<Frame>& refFrame,
